...
export default function FacturaViewPage() {
  ...
  const pdfFileName = `${data.numero || `Factura_${id}`}_${sanitize(data.cliente?.nombre_razon_social)}.pdf`;
  ...
  return (
    <div className="max-w-4xl mx-auto space-y-4 pb-10">
      ...
      <div className="flex justify-between items-center bg-white p-3 rounded-lg shadow-sm border d-print-none">
        ...
        <PDFDownloadLink
          document={<DocumentoPDF data={data} empresa={empresa} logoUrl={logoUrl} tipo="Factura" />}
